...
#copy/paste all content of /etc/skel over to home folder - backup of cnfig created - beware
...
#emulator 
alias emulator="cd ~/src/emulator && ./emulator -avd my_emulator"
...
export LD_lIBRARY_PATH=/opt/oracle/instantclient_21_4:$PATH
